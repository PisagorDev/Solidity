...
contract BattleMancers is ERC721A, BattleMancersModeratorAccess, ReentrancyGuard {
    ...
    uint256 public MINT_SUPPLY = 777;
    uint256 public FREE_MINT = 7000;
    uint256 public MAX_SUPPLY = MINT_SUPPLY + FREE_MINT;
    ...
    function publicMint(uint256 quantity) external payable{
        ...
        require(totalSupply().add(quantity) <= MINT_SUPPLY);
